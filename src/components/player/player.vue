<template>
  <div class="player" v-show="playList.length>0">
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom" ref="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right" :class="disableBtn">
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="Maximization">
        <div class="icon">
          <img width="40" height="40" :src="currentSong.image" :class="cdStage">
        </div>
        <div class="text">
        ...
        <div class="control">
          <progress-circle :radius="radius" :percent="percent">
            <i :class="playIconMini" @click.stop="togglePlay" class="icon-mini"></i>
          </progress-circle>
        </div>
        <div class="control">
  ...
  export default {
    ...
    mounted(){
      if(window.innerHeight <= 568){
        this.$refs.bottom.style.bottom = '15px'
      }
    },
    methods: {
      ended(){
      ...
      leave(el, done){
        ...
        let animation = {
          ...
          60: {
            transform: `translate3d(${x}px, ${y}px, 0) scale(${scale * 0.8})`
          },
          100: {
      ...
      _getPosAndScale(){
        ...
        const y = window.innerHeight - cdWidth / 2 - paddingTop - paddingBottom
        return {x, y, scale}
      },
      minimise(){
