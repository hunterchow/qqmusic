<template>
  <scroll class="listview" :probeType="probeType" :data="data" ref="listview" @scroll="scroll"
      ...
      <li v-for="group in data" class="list-group" ref="listGroup">
        ...
        <ul>
          <li v-for="item in group.items" class="list-group-item" @click="selectItem(item)">
            ...
            <div class="name-wrapper border-1px">
    ...
    <div class="list-shortcut" @touchstart.stop.prevent="onShortcutTouchStart"
      ...
      <ul>
        <li class="item" v-for="(item,index) in shortcut" :data-index="index"
      ...
      .list-group-item
        ...
        .name-wrapper
          ...
          .icon-right
            ...
            border-width: 1px
            border-style: solid
            border-color: rgba(0, 0, 0, .8) rgba(0, 0, 0, .8) transparent transparent
    .list-shortcut
      position: absolute
      z-index: 30
      right: 0
